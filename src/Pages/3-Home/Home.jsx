...
export default function AllPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background" dir="rtl">
      <h1 className="text-center text-4xl mt-4 mb-32 mt-16">الأهداف اليومية</h1>
        ...
        {goals.map((goal) => (
          ...
          >
            <div className="bg-secondary rounded-lg flex flex-col items-center justify-center p-4 text-center">
              <img
                src={`/public/images/images/${goal.img}`}
                alt={goal.title}
      ...
      <nav className="fixed bottom-0 container">
        <div className="relative flex justify-around items-center bg-[#065B51] h-16 rounded-t-xl">
          {/* Home Icon in Circle - CENTERED */}
          <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-[#065B51] rounded-full">
            <div className="bg-white rounded-full p-6">
              <Home className=" h-8 w-8 text-[#065B51]" />
            </div>
          </div>
