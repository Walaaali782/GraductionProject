  ...
  return (
    <div className="bg-white rounded-lg p-6 w-full max-w-sm mx-auto min-h-[90vh] relative overflow-hidden text-right">
      ...
      <div className="absolute top-4 right-4 flex flex-col items-center z-10">
        ...
        />
        <h2 className="text-lg font-bold">الحالة المزاجية</h2>
      </div>

      <div className="mt-36 space-y-8 text-center">
        <p className="text-gray-800 font-medium">إي أخبار مزاجك؟</p>

        <div className="grid grid-cols-2 gap-10 text-center">
          {moods.map((mood, index) => (
            <button
              key={index}
              className="bg-[#75D6C6] text-white py-2 px-4 rounded-full flex justify-between items-center gap-2"
            >
        ...
        <button className="bg-[#75D6C6] text-white py-2 mt-8 rounded-full w-[200px] mx-auto font-bold">
          حفظ
        </button>
      </div>
    </div>
