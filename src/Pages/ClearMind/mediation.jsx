...
const Mediation = () => {
  ...
  return (
    <div className="bg-white rounded-lg p-6 w-full min-h-[90vh] relative overflow-hidden text-right font-cairo">
      ...
      {/* النموذج والأزرار */}
      <div className="flex flex-col justify-between h-[70vh] mt-32">
        <div>
        ...
        <div className="flex flex-col items-center space-y-4 pb-6">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-[#75D6C6] hover:bg-[#5bc4b2] transition px-4 py-2 rounded w-[230px] text-md font-semibold"
          >
